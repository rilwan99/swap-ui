      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <Card className="border-2 shadow-2xl backdrop-blur-sm bg-card/50 transition-all duration-300">
          <CardContent className="p-6 md:p-8">
            {/* Header */}
            <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 bg-gradient-to-r from-primary via-purple-600 to-blue-600 dark:from-primary dark:via-secondary dark:to-accent bg-clip-text text-transparent fade-in slide-in-from-top-4 duration-700">
